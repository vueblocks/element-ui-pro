<template>
  <section class="content">
    ...
    <section class="component-code-preview" v-for="(item, index) in demoData"  :key="index">
  ...
  data () {
    return {
      ...
      attrData: [
        ...
        { attribute: 'type', description: '主题', type: 'String', acceptedValues: 'primary / success / warning / danger / info', defaultValues: 'primary' },
